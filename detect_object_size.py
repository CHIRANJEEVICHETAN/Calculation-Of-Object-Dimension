...
def main():
    ...
    ap.add_argument("-m", "--mode", type=str, choices=["image", "video", "dimension"], default="image", help="mode of the operation: 'image', 'video' or 'dimension' (default is 'video')")
    ap.add_argument("-w", "--width", type=float, required=True, help="width of the left-most object in the image (in inches)")
    ap.add_argument("-c", "--capture", type=str, default="video", help="mode of the operation ('image' or 'video')")
